...
__webpack_require__(/*! ./filmSearch */ "./resources/js/filmSearch.js");
...
var FilmSearch = /*#__PURE__*/function () {
  function FilmSearch() {
    _classCallCheck(this, FilmSearch);

    _defineProperty(this, "field", void 0);

    _defineProperty(this, "resultZone", void 0);
  ...
  _createClass(FilmSearch, [{
    ...
    value: function search(e) {
      ...
      this.timeout = window.setTimeout(function () {
        _this2.bufferedSearch(e.target.value);
      }, 200);
    }
  }, {
    key: "bufferedSearch",
    value: function bufferedSearch(search) {
      var _this3 = this;

      this.displayMessage('...');

      if (search !== '') {
        fetch("/api/films/" + search).then(function (response) {
          return response.json();
        }).then(function (json) {
          _this3.handleSearchResponse(json);
        })["catch"](function (err) {
          console.error(err);
        });
      } else {
    ...
    value: function displayResults(results) {
      ...
      if (results.length === 0) {
        ...
        results.forEach(function (item) {
          ...
          _this4.resultZone.appendChild(itemLine);
        });
      }
    }
  }]);
